...
# Taken from DINO implementation
...
def init_distributed_mode(args):
    ...
    dist.init_process_group(
        backend="gloo",
        init_method=args.dist_url or args.dist_filestore,
...
def create_vae(checkpoint_path):
    if exists(checkpoint_path):
        vae_path = Path(checkpoint_path)
        ...
        raise ValueError('VAE model file does not exist')
